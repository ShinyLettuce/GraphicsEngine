...
public:
	...
	Vector3 GetPosition() const { return Vector3{ myProjectionMatrix.worldToClipMatrix[12], myProjectionMatrix.worldToClipMatrix[13], myProjectionMatrix.worldToClipMatrix[14] }; }
